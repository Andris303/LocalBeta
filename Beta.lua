...
local rob_murder = Troll:CreateButton({
    ...
    Callback = function()
        ...
        if not game:GetService("Players")[target_name].Character:WaitForChild("isInArena").Value or target_name.Character:WaitForChild("HumanoidRootPart").Health == 0 then
